...
const Form = () => {
  ...
  return (
    <div className="2xl:w-fit bg-card-bg items-center justify-evenly p-8 rounded-xl shadow-md shadow-slate-700">
      ...
      <div>
        {results && (
          <div className="sm:w-32 lg:w-60 h-auto p-6 rounded-md bg-card-bg">
